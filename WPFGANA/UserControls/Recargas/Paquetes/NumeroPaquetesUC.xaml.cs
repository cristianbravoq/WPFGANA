...
{
    /// <summary>
    /// Lógica de interacción para NumeroPaquetesUC.xaml
    /// </summary>
    public partial class NumeroPaquetesUC : UserControl
    {
        ...
        public NumeroPaquetesUC(TransactionBetPlay transaction)
        {
            InitializeComponent();
        ...
        private void BtnContinuar_TouchDown(object sender, TouchEventArgs e)
        {
            if (validateNum())
            {
                ...
                Utilities.navigator.Navigate(UserControlView.ValidatePack, Transaction);
            }
        }
